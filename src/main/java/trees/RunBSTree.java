...
public class RunBSTree {
	...
	//	System.out.println("-------");
		//b.allRootToLeafPaths(b.root, 90);
		//BSTree.mirrorBuiltInplace(b.root);
		//b.traversalLevelLineByLine(b.root); 
	//	b.traversalLevelRecursive(b.root);
	///	System.out.println("-------");
	//	b.printBoundary(b.root);
	//	List<String> paths = new ArrayList<>();
	//	BSTree.rootToLeafPathBinaryTree(b.root, "", paths);
		//paths.forEach(e -> System.out.println(e));
		
		//System.out.println(BSTree.checkRootToLeafPathSum(b.root, 90));
		
		
		
		//Stack<Integer> s2=new Stack<>();
		//b.rootToLeafPathBacktracking(b.root);
		//b.rootToLeafPathBacktrackingII(b.root,s2);
		...
		// b.rootToLeafPathBacktracking(b.root);
		//System.out.print(BSTree.isSibling(b.root, 40, 10));
		//System.out.println();
		//System.out.println(BSTree.isCousin(b.root, 40, 55));
		 b.allRootToLeafPaths(b.root);
		...
		// b.printList(b.head);
		  ...
		  res.max_sofar = Integer.MIN_VALUE; 
		// Let us create trees shown in above diagram 
	        ...
	        tree.calculateMaxSum(tree.root, res); 
	        System.out.println("maximum path sum is : " +res.max_sofar);
	        
	        int []max={Integer.MIN_VALUE};
	        tree.calculateMaxSum(tree.root, max);
		...
		// tree2.traversalLevelLineByLine(tree2.root);
		 ...
		 // System.out.println(BSTree.isIsomorphic(tree.root, tree2.root));
		//BSTree.mirrorBuiltInplace(b.root);
	//	b.traversalLevelLineByLine(b.root); 
